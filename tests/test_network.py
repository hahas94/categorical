...
class TestNetwork(unittest.TestCase):
    def setUp(self):
        ...
        self.obs_shape_image = (4, 84, 84)  # Example shape for image input
        self.obs_shape_vector = (6,)  # Example shape for vector input
        self.n_actions = 4
        self.n_atoms = 51
    ...
    def test_network_image_obs(self):
        ...
        sample_input = torch.zeros(1, *self.obs_shape_image)  # Batch size of 1
    ...
    def test_network_vector_obs(self):
        ...
        sample_input = torch.zeros(1, *self.obs_shape_vector)  # Batch size of 1
        output = net(sample_input)
        expected_shape = (1, self.n_actions, self.n_atoms)
        self.assertEqual(output.shape, expected_shape)
